...
public class _03_A_PalavrasMaisUtilizadasNasAvaliacoes {
	...
	public static class TokenizerMapper extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			try {
				...
				String line = (String) json.get("text");
	...
	public static void main(String[] args) throws Exception {
		...
		jobFirst.setJarByClass(_03_A_PalavrasMaisUtilizadasNasAvaliacoes.class);
		...
		jobSecond.setJarByClass(_03_A_PalavrasMaisUtilizadasNasAvaliacoes.class);
