...
public class _02_D_SentencasRelacionadasADilma {
	...
	public static void main(String[] args) throws Exception {
		...
		jobFirst.setJarByClass(_02_D_SentencasRelacionadasADilma.class);
		...
		jobSecond.setJarByClass(_02_D_SentencasRelacionadasADilma.class);
