...
public class _03_C_TopicosRelacionadosARevisoes {
	...
	public static void main(String[] args) throws Exception {
		...
		jobFirst.setJarByClass(_03_C_TopicosRelacionadosARevisoes.class);
		...
		jobSecond.setJarByClass(_03_C_TopicosRelacionadosARevisoes.class);
